  ...
  async getTokenUtxos (address, tokenId, utxoDelay) {
    try {
      ...
      */
      ...
      if (this.env.VERBOSE_LOG >= 1) console.log(`hydratedUtxos: ${JSON.stringify(hydratedUtxos, null, 2)}`)
  ...
  async agMerit (address, tokenId, utxoDelay) {
    try {
      ...
      */
      ...
      if (this.env.VERBOSE_LOG >= 1) console.log(`agMerit address: ${address} tokenId: ${tokenId}`)
